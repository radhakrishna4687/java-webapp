pipeline {
    ...
    stages {
        stage ('Clone Repository') {
            steps {
               ...
               // git credentialsId: 'github', url: 'https://github.com/radhakrishna4687/:${GITHUB_BRANCH}'
                gitbranch: "master", url 'https://github.com/radhakrishna4687/java-webapp.git'
        ...
        stage ('Docker image push to Dockerhub Repository') {
            steps {
                sh 'docker tag ${CONTAINER_NAME} radhakrishna4687/${DOCKER_IMAGE}:v1'
            }
        }
        stage ('Push docker image to DockerHub') {
            steps {
                withCredentials([string(credentialsId: 'dockerhub', variable: 'dockerhubpwd')]) {
                    ...
                    sh "docker push radhakrishna4687/${DOCKER_IMAGE}:v1"
                }
            }
        }
    }
